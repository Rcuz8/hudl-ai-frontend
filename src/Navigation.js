...
function Navigation() {
    ...
    return (
        <div class='navmenu'>
            ...
            {AccordionCard(4,'View Data', <ViewData filmData={filmData_withHeaders} callback={viewed_data_and_generated_nn_model} />)}
            {AccordionCard(5,'Get Predictions', <Predictions model={nn_model} dataDomain={dataDomain} headers={filmData_withHeaders ? filmData_withHeaders.headers : null} outputs={output_indices} />)}
            </Accordion>
        </div>
